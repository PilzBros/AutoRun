    ...
    public void query() {
        ...
        try {
            ...
            if (array.size() > 0) {
                ...
                if (Double.parseDouble(versionName) > Double.parseDouble("1.4")) {
                    ...
                    System.out.println("");
                    Autorun.updateNeeded = true;
                } else {
                    System.out.println("[Autorun] You're running the latest version!");
                }
            } else {
                System.out.println("[Autorun] You are running the latest version");
            }
